...
<body>
	<div class="container">
		...
		<!-- form -->
		<form class="form-signin" action="${pageContext.request.contextPath}/user/login.do">
			<input type="text" class="form-control" name="id" placeholder="아이디"> <input
			...
			<div class="row form-btn">
				...
				<button type="button" class="btn btn-large btn-default">회원가입</button>
			</div>
		</form>
